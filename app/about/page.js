          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: "What are the main programs offered by Selam CBO?", answer: "Our key programs include Education, Healthcare, Community Development, and Water & Sanitation. We also focus on women's empowerment and youth mentorship.", color: "bg-teal-700" },
